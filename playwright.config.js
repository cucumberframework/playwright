...
module.exports = defineConfig({
  ...
  /* Retry on CI only */
  retries: process.env.CI ? 2 : 1, //we can set retry mechanism on local and on gitHub actions 
  /* Opt out of parallel tests on CI. */
  workers: process.env.CI ? 1 : 8, // This will define now many nodes will it open while execution in parallel mode. 
